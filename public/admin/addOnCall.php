...
?>
                    ...
                    <div class="container-fluid p-3">
                        ...
                        <form method="POST" enctype="multipart/form-data" id="myForm" action="../../private/addOnCall_process.php">
                            <div class="row my-3">
                            ...
                            <div class="row">
                                <div class="col-sm">
                                    ...
                                    <div class="input-group mt-2">
                                        ...
                                        <input type="text" class="form-control" name="add10" tabindex="11" required>
                                    </div>
                                </div>
                                <div class="col-sm">
                                    <div class="input-group">
                                    ...
                                    <div class="input-group mt-2">
                                        ...
                                        <input type="email" class="form-control" name="add5" oninput="up(this)" tabindex="6" required>
                                    </div>
                                    <div class="input-group mt-2">
                                        <span class="input-group-text">SSS NUMBER</span>
                                        <input type="text" class="form-control" name="add8" oninput="num(this)" tabindex="9" required>
                                    </div>
                                    <div class="input-group mt-2">
                                ...
                                <div class="col-sm">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" name="add3" oninput="letters(this)" tabindex="4" required>
                                    </div>
                                    <div class="input-group mt-2">
                                        <span class="input-group-text">PHONE NUMBER</span>
                                        <input type="text" class="form-control" name="add6" oninput="num(this)" tabindex="7" required>
                                    </div>
                                    <div class="input-group mt-2">
                                        <span class="input-group-text">PHILHEALTH NUMBER</span>
                                        <input type="text" class="form-control" name="add9" oninput="num(this)" tabindex="10" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row mt-3">
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-sm">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" name="add13" oninput="letters(this)" tabindex="14" required>
                                    </div>
                                </div>
                                <div class="col-sm">
                                    <div class="input-group">
                                        <span class="input-group-text">PHONE NUMBER</span>
                                        <input type="text" class="form-control" name="add14" oninput="num(this)" tabindex="15" required>
                                    </div>
                                </div>
                            </div>
                            <div class="input-group mt-2">
                                <span class="input-group-text">ADDRESS</span>
                                <input type="text" class="form-control" name="add15" oninput="up(this)" tabindex="16" required>
                            </div>
                            <div>
